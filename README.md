...
npx @nextzy-tech/clickup-git-sync log --task "Fix bug" --category "Main Task [Backend]" --h 1 --min 30 --start-date 2026-07-01
```
...
```bash
npx @nextzy-tech/clickup-git-sync task --task "Investigate flaky test" --category "Main Task [Testing]"
```
